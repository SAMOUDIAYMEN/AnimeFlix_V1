...
namespace AnimeFlix.Controllers
{
    public class ManageAnimesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,titleAnime,src,studion,author,descriptionAnime,ratingAnime,imgAnime,trailerAnime,runtime,categoryAnime")] ManageAnime manageAnime)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,titleAnime,src,studion,author,descriptionAnime,ratingAnime,imgAnime,trailerAnime,runtime,categoryAnime")] ManageAnime manageAnime)
        {
